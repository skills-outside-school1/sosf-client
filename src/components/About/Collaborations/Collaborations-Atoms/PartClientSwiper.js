...
const PartClientSwiper = () => {
  const bgImages = [
    "/assets/images/collaborations/our-clients.jpg",
    "/assets/images/collaborations/our-partners.jpg",
    "/assets/images/collaborations/our-investors.jpg",
  ];
  ...
  return (
    <div className="relative h-[420px] w-full overflow-hidden">
      <div className="w-full h-[420px] bg-black bg-opacity-25 absolute top-0 left-0 ">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 w-full">
            ...
            >
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    <Image
                      ...
                      height={400}
                      alt="collaboration"
                      className="h-[140px] w-[200px] rounded-[100%] object-cover "
                    />
                  </motion.div>
                </AnimatePresence>
              </div>
              ...
              <p className="text-[#1F2937] font-inter leading-7">
                ...
                ambassadors and beneficiaries. We exist for them and to ensure
                we drive development for individuals and institutions.
              </p>
            </motion.div>
          </div>
        </div>
