    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-6xl max-h-[95vh] overflow-y-auto p-0 sm:max-w-[90vw]">
        ...
        <div className="p-4 sm:p-6 md:p-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-5 md:gap-6 justify-items-center">
            {/* As a Catalyst */}
            <Card className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100 hover:shadow-lg transition-all duration-300 group w-full max-w-sm">
              <CardContent className="p-4 sm:p-5 md:p-6 text-center h-full flex flex-col">
                ...
                <h3 className="font-bold text-gray-900 mb-2 sm:mb-3 text-base sm:text-lg">As a Catalyst (Ambassador)</h3>
                <p className="text-xs sm:text-sm text-gray-600 mb-4 sm:mb-6 leading-relaxed flex-grow">
                ...
                <Button className="bg-blue-600 hover:bg-blue-700 text-white w-full font-semibold py-2 sm:py-3 text-xs sm:text-sm">
                  Get Started →
                </Button>
              </CardContent>
            </Card>
            ...
            {/* As a Mobilizer */}
            <Card className="bg-gradient-to-br from-green-50 to-emerald-50 border border-green-100 hover:shadow-lg transition-all duration-300 group w-full max-w-sm">
              <CardContent className="p-4 sm:p-5 md:p-6 text-center h-full flex flex-col">
                <div className="mb-3 sm:mb-4">
                ...
                <h3 className="font-bold text-gray-900 mb-2 sm:mb-3 text-base sm:text-lg">As a Mobilizer</h3>
                <p className="text-xs sm:text-sm text-gray-600 mb-4 sm:mb-6 leading-relaxed flex-grow">
                ...
                <Button className="bg-green-600 hover:bg-green-700 text-white w-full font-semibold py-2 sm:py-3 text-xs sm:text-sm">
                  Register →
                </Button>
              </CardContent>
            </Card>
            ...
            {/* As a Connector */}
            <Card className="bg-gradient-to-br from-purple-50 to-violet-50 border border-purple-100 hover:shadow-lg transition-all duration-300 group w-full max-w-sm">
              <CardContent className="p-4 sm:p-5 md:p-6 text-center h-full flex flex-col">
                <div className="mb-3 sm:mb-4">
                ...
                <h3 className="font-bold text-gray-900 mb-2 sm:mb-3 text-base sm:text-lg">As a Connector</h3>
                <p className="text-xs sm:text-sm text-gray-600 mb-4 sm:mb-6 leading-relaxed flex-grow">
                ...
                <Button className="bg-purple-600 hover:bg-purple-700 text-white w-full font-semibold py-2 sm:py-3 text-xs sm:text-sm">
                  Join Now →
                </Button>
              </CardContent>
            </Card>
            ...
            {/* As a Champion */}
            <Card className="bg-gradient-to-br from-orange-50 to-amber-50 border border-orange-100 hover:shadow-lg transition-all duration-300 group w-full max-w-sm">
              <CardContent className="p-4 sm:p-5 md:p-6 text-center h-full flex flex-col">
                <div className="mb-3 sm:mb-4">
                ...
                <h3 className="font-bold text-gray-900 mb-2 sm:mb-3 text-base sm:text-lg">As a Champion</h3>
                <p className="text-xs sm:text-sm text-gray-600 mb-4 sm:mb-6 leading-relaxed flex-grow">
                ...
                <Button className="bg-orange-600 hover:bg-orange-700 text-white w-full font-semibold py-2 sm:py-3 text-xs sm:text-sm">
                  Be a Champion →
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-red-50 to-rose-50 border border-red-100 hover:shadow-lg transition-all duration-300 group w-full max-w-sm">
              <CardContent className="p-4 sm:p-5 md:p-6 text-center h-full flex flex-col">
                <div className="mb-3 sm:mb-4">
                ...
                <h3 className="font-bold text-gray-900 mb-2 sm:mb-3 text-base sm:text-lg">As an Awareness Builder</h3>
                <p className="text-xs sm:text-sm text-gray-600 mb-4 sm:mb-6 leading-relaxed flex-grow">
                  Advocacy for Awareness Building to co-host an event / strategic campaign or to be an event to speak
                </p>
                <Button className="bg-red-600 hover:bg-red-700 text-white w-full font-semibold py-2 sm:py-3 text-xs sm:text-sm">
                  Invite Now →
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-teal-50 to-cyan-50 border border-teal-100 hover:shadow-lg transition-all duration-300 group w-full max-w-sm">
              <CardContent className="p-4 sm:p-5 md:p-6 text-center h-full flex flex-col">
                <div className="mb-3 sm:mb-4">
                ...
                <h3 className="font-bold text-gray-900 mb-2 sm:mb-3 text-base sm:text-lg">As a Policy Advocate</h3>
                <p className="text-xs sm:text-sm text-gray-600 mb-4 sm:mb-6 leading-relaxed flex-grow">
                ...
                <Button className="bg-teal-600 hover:bg-teal-700 text-white w-full font-semibold py-2 sm:py-3 text-xs sm:text-sm">
