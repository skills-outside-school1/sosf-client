...
const LiquidAssets = [
  ...
  { name: "Commercial Paper",
    tooltip: "Short-term loan given to companies, usually by other businesses or investors."
   },
  { name: "Bonds- Corporate / Government (Local)",
    tooltip: "Loans to local governments or companies that pay interest over time."
   },
  { name: "Mutual Funds",
    tooltip: "A pool of money from many people, managed by experts to invest in stocks, bonds, etc."
   },
  { name: "Bonds- Corporate / Government (Eurobond)",
    tooltip: "Bonds issued in a currency different from the country where they're sold."
   },
  ...
  { name: "Waqf",
    tooltip: "A charitable endowment in Islam; assets donated for religious or social good."
   },
  { name: "Fixed Deposits",
    tooltip: "Money locked in a bank for a fixed time with a fixed interest rate."
     },
]
...
const nonLiquidAssets = [
  ...
  { name: "Cryptocurrency / NFTs",
    tooltip: "Digital assets (like Bitcoin or digital art) that are traded online."
   },
  { name: "Movable Goods",
    tooltip: "Physical items that can be moved, like vehicles or equipment."
   },
  { name: "Royalties, Mineral Rights & Licenses",
    tooltip: "Earnings from intellectual property like books, music, or patents."
   },
  ...
  { name: "Real-Estate (Land / Completed Property; Residential / Commercial / Industrial)",
    tooltip: "Buying land or property to earn rental income or sell at a higher price."
  },
]

const financialContributionTypes = [
  { name: "Individual Donation",
    tooltip: "Giving money directly to people or causes (can be viewed as social impact investment)."
  },
  { name: "CSR Capital",
    tooltip: "Funds set aside by companies for Corporate Social Responsibility projects."
  },
  { name: "Grant Funding",
    tooltip: "Money given (not repaid) for a specific project, usually by governments or donors."
  },
  { name: "Zakat",
...
const inKindResources = [
    {
        ...
        description: "Contributing products from you or your organization at a subsidized rate, free, or adapting them to meet the needs of SOSF beneficiaries.",
        action: "organization"
    },
    {
        icon: <CustomIcon src={services} className="h-6 w-6 text-gray-700" />,
        title: "In-Kind Resources – Services",
        description: "Contributing services from you or your organization at a subsidized rate, free, or adapting them to meet the needs of SOSF Trust beneficiaries.",
        action: "organization"
    },
    {
        icon: <CustomIcon src={expertise} className="h-6 w-6 text-gray-700" />,
        title: "In-Kind Resources – Expertise",
        description: "Contribute your rich & vast network, knowledge or skills on a pro bono basis to benefit our SOSF beneficiaries indirectly by joining the SOSF Advisors",
        action: "network"
    }
]
            ...
            <div className="space-y-8">
              ...
              <div className="text-left bg-background_blue p-10 rounded-[24px]">
                ...
                <div className="mt-6 md:hidden">
                  <Link href="#" className="flex items-center justify-start space-x-2 text-gray-700 font-medium hover:text-black transition-colors">
                    <span>See Form</span>
                    <ArrowIcon />
                  </Link>
                </div>
