        ...
        <Animate animation="fade-left" delay={200}>
          <div>
            ...
            <p className="text-md font-inter font-normal my-4">
              Each module is packed with actionable insights, real-life
              examples, and AI tools designed to simplify complex tasks. For
              example:
            </p>
              ...
              <Animate animation="zoom-in" delay={300}>
                <div className="bg-[#F8F8F8] py-2 px-6 rounded-lg leading-7 mt-6">
                  ...
                  <p>
                    ...
                    registration, understand owner/director roles, draft
                    critical documents, set up effective boards, design smart
                    shareholding, optimize tax obligations.
                  </p>
                </div>
              </Animate>
              ...
              <Animate animation="zoom-in" delay={400}>
                <div className="bg-[#F8F8F8] py-2 px-6 rounded-lg leading-7 mt-2">
                  ...
                  <p>
                    ...
                    brand identity, messaging, and positioning. Learn strategies
                    for identifying and targeting ideal customers, effective
                    communication.
                  </p>
                </div>
              </Animate>
