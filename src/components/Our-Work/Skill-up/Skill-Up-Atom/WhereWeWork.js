...
import Animate from "@/components/shared/Animate"; // adjust path
...
const WhereWeWork = () => {
  ...
  return (
    <div>
      <Animate animation="fade-down" duration={1200}>
        <div className="text-center flex flex-col justify-center items-center px-4">
          ...
          <p className="text-base md:text-lg leading-relaxed max-w-3xl font-inter font-light mb-12">
            ...
            access via mobile and desktop. Priority geographies are determined
            by:
          </p>
        </div>
      </Animate>

      <Animate animation="fade-up" duration={1200} delay={100}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 my-16 px-4 md:px-16">
        <Animate animation="fade-right" duration={1200}>
          <div>
            ...
            <p className="font-medium font-mont text-md leading-8 mt-6">
              ...
              SOSF's broader Venture Philanthropy approach. Managed by PIF
              Africa and Tongston Ventures, this online learning solution
              provides targeted courses and tools globally, fostering both
              entrepreneurs and intrapreneurs to prepare for the future of work
              and enterprise.
            </p>
          </div>
        </Animate>

        <Animate animation="fade-left" duration={1200} delay={200}>
          <div>
            <h1 className="font-semibold font-mont text-[20px] my-6">
